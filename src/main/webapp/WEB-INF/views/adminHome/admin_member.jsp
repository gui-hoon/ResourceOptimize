    ...
    <body>
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                <div class="container-fluid">
                <h1 class="mt-4">Member</h1> <br> <br> <br>
                    <div style="text-align: center;">
                    <h2 class="mt-4">User List</h2>
	                    <table style="width: 80%; margin: auto">
	                   		<thead>
	                    		<tr>
	                    			<th>num</th><th>userId</th><th>userPw</th><th>userName</th><th>userAuth</th><th>appendDate</th><th>updateDate</th>					
	                   			</tr>
                  			</thead>
                  			<tbody>
