    ...
    <body>
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                <div class="container-fluid">
                    <h1 class="mt-4">"${dynaKey.environmentID}"</h1>
                    <div style="text-align: center;">
						<br> <h3>Dynatrace 계정</h3>
						<hr>
						<form action="updateDynaKey" method="POST">
							<input type="hidden" name="num" value="${dynaKey.num}"/>
						    <table style="width: 900px; margin: auto">
						        <tr>
						            <td width="70" style="background-color: skyblue;">environment</td>
						            <td><input style="width:800px" type="text" name="environmentID" value="${dynaKey.environmentID}"/></td>
						        </tr>
						        <tr>
						            <td style="background-color: skyblue;">accessKey</td>
						            <td><input style="width:800px" type="text" name="environment" value="${dynaKey.environment}"/></td>
						        </tr>
						        <tr>
						            <td style="background-color: skyblue;">access token</td>
						            <td><input style="width:800px" type="text" name="token" value="${dynaKey.token}"/></td>
						        </tr>
						        <tr>
						...
						<hr>
					    <br> 
					    <input type="button" value="계정 삭제" onclick="if(!confirm('삭제하시면 복구할수 없습니다.\n정말로 삭제하시겠습니까?')){return false;}; location.href='deleteDynaKey?num=${dynaKey.num}&environmentID=${dynaKey.environmentID}'">
